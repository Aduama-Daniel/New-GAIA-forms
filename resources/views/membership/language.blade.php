...
<body id="langBody">
   <div class="card" id="langCard">
      ...
      <form id="step1Form" action="{{url( route('membership.store', ['step' => 2])) }}" method="post">
@csrf <!-- Laravel CSRF token -->   
      <h3>Language Proficiency</h3>
         ...
         <div class="nav">
            <button type="button"><a href="{{url(route('membership.form'))}}" class="page-link">Back</a></button>   
